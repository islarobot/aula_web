        ...
        <div class="container">
            ...
            <div class="row">
                <table class="table">
                    ...
                    <tbody>
                        <?php
$sql ="select ficha.name, ficha.code, precios.precio, precios.entrada from ficha join precios on precios.ficha_id=ficha.id";
$preus = $pdo->query($sql)->fetchAll(PDO::FETCH_ASSOC);
foreach ($preus as $cotxe) {
    echo '<tr>';
    echo '<td>', $cotxe["name"], '</td>';
    echo '<td>', $cotxe["precio"],'€ </td>';
